...
@section('content')
    <div class="w-3/4 mx-auto py-6">
        ...
        @else
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ number_format($order->price, 2, ',', ' ') }} ₽</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
            ...
            <h3 class="mt-4 text-lg font-semibold">Итоговая стоимость всех заказов: <span class="text-green-600">{{ number_format($totalOrderPrice, 2, ',', ' ') }} ₽</span></h3>
        @endif
    </div>
